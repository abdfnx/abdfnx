...
- [scmn-dev/sm-extension](https://github.com/scmn-dev/sm-extension) - official browser extension for secman. (2 days ago)
- [scmn-dev/install](https://github.com/scmn-dev/install) - secman installer. (2 days ago)
...
- [scmn-dev/docker](https://github.com/scmn-dev/docker) ([v0.2.2](https://github.com/scmn-dev/docker/releases/tag/v0.2.2), 3 days ago) - 🐳 official docker image for secman.
...
- [link scmn-dev/cli.secman.dev with abdfnx/cli.secman.dev](https://github.com/scmn-dev/cli.secman.dev/pull/250) on [scmn-dev/cli.secman.dev](https://github.com/scmn-dev/cli.secman.dev) (3 days ago)
- [link scmn-dev/cli.secman.dev with abdfnx/cli.secman.dev](https://github.com/abdfnx/old-sm-cli.dev/pull/2) on [abdfnx/old-sm-cli.dev](https://github.com/abdfnx/old-sm-cli.dev) (3 days ago)
