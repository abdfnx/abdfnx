...
- [scmn-dev/secman](https://github.com/scmn-dev/secman) ([v6.0.3](https://github.com/scmn-dev/secman/releases/tag/v6.0.3), today) - 🔒 The password manager of your dreams.
