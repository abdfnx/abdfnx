...
- [abdfnx/gh-resto](https://github.com/abdfnx/gh-resto) ([v0.1.1](https://github.com/abdfnx/gh-resto/releases/tag/v0.1.1), today) - the github cli extension of resto - `a CLI app can send pretty HTTP &amp; API requests with TUI`
- [abdfnx/resto](https://github.com/abdfnx/resto) ([v0.1.1](https://github.com/abdfnx/resto/releases/tag/v0.1.1), today) - a CLI app can send pretty HTTP &amp; API requests with TUI
