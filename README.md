...
- [abdfnx/server](https://github.com/abdfnx/server) - secman vscode server (today)
- [scmn-dev/secman](https://github.com/scmn-dev/secman) - 🔒 The password manager of your dreams. (2 days ago)
- [scmn-dev/secman-v1](https://github.com/scmn-dev/secman-v1) - 💀 The former secman of scmn-dev/secman (deprecated) (2 days ago)
...
- [scmn-dev/sm-win](https://github.com/scmn-dev/sm-win) - sub-app of secman for windows. (4 days ago)

#### 💻 My latest projects

- [abdfnx/server](https://github.com/abdfnx/server) - secman vscode server
...
- [scmn-dev/secman-v1](https://github.com/scmn-dev/secman-v1) ([v5.3.8](https://github.com/scmn-dev/secman-v1/releases/tag/v5.3.8), 2 days ago) - 💀 The former secman of scmn-dev/secman (deprecated)
- [scmn-dev/desktop](https://github.com/scmn-dev/desktop) ([v1.0.3](https://github.com/scmn-dev/desktop/releases/tag/v1.0.3), 3 days ago) - 🖥️ Secman Desktop is the desktop client for secman. powered by @scmn-dev.
- [scmn-dev/secman](https://github.com/scmn-dev/secman) ([v5.3.8](https://github.com/scmn-dev/secman/releases/tag/v5.3.8), 5 days ago) - 🔒 The password manager of your dreams.
- [scmn-dev/sm-win](https://github.com/scmn-dev/sm-win) ([v0.2.4](https://github.com/scmn-dev/sm-win/releases/tag/v0.2.4), 5 days ago) - sub-app of secman for windows.
...
- [update changelog theme](https://github.com/secman-archive/changelog/pull/11) on [secman-archive/changelog](https://github.com/secman-archive/changelog) (5 days ago)
