...
- [abdfnx/gosh](https://github.com/abdfnx/gosh) ([v0.4.0](https://github.com/abdfnx/gosh/releases/tag/v0.4.0), 3 days ago) - ⌨ A golang library for executing bash &amp; powershell commands easly.
- [denoland/deno](https://github.com/denoland/deno) ([v1.27.0](https://github.com/denoland/deno/releases/tag/v1.27.0), 1 week ago) - A modern runtime for JavaScript and TypeScript.
