...
- [abdfnx/tran](https://github.com/abdfnx/tran) ([v0.1.0](https://github.com/abdfnx/tran/releases/tag/v0.1.0), today) - 🖥 Securely transfer and send anything between computers with TUI.
- [abdfnx/gh-tran](https://github.com/abdfnx/gh-tran) ([v0.1.0](https://github.com/abdfnx/gh-tran/releases/tag/v0.1.0), 1 day ago) - the gh cli extension of tran `🖥 Securely transfer and send anything between computers with TUI.`
- [denoland/deno](https://github.com/denoland/deno) ([v1.18.2](https://github.com/denoland/deno/releases/tag/v1.18.2), 5 days ago) - A modern runtime for JavaScript and TypeScript.
