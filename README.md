...
- [abdfnx-cemetery/resto-action](https://github.com/abdfnx-cemetery/resto-action) - :octocat: GitHub action for Resto (3 days ago)
- [scmn-dev/get-latest](https://github.com/scmn-dev/get-latest) - Get the latest repository version (3 days ago)
- [abdfnx/get-latest-repo](https://github.com/abdfnx/get-latest-repo) - Get the latest version of a repo (4 days ago)

### 🔭 Latest releases I've contributed to

- [scmn-dev/editor](https://github.com/scmn-dev/editor) ([v6.1.3](https://github.com/scmn-dev/editor/releases/tag/v6.1.3), 2 days ago) - The secman settings editor for secman cli.
- [scmn-dev/secman](https://github.com/scmn-dev/secman) ([v6.1.3](https://github.com/scmn-dev/secman/releases/tag/v6.1.3), 2 days ago) - 👊 Human-friendly and amazing secrets manager.
- [dlvhdr/gh-prs](https://github.com/dlvhdr/gh-prs) ([v2.0.1](https://github.com/dlvhdr/gh-prs/releases/tag/v2.0.1), 2 days ago) - gh cli extension to display a dashboard of PRs - configurable with a beautiful UI.
- [scmn-dev/get-latest](https://github.com/scmn-dev/get-latest) ([v0.1.2](https://github.com/scmn-dev/get-latest/releases/tag/v0.1.2), 3 days ago) - Get the latest repository version
- [abdfnx/get-latest-repo](https://github.com/abdfnx/get-latest-repo) ([v0.1.0](https://github.com/abdfnx/get-latest-repo/releases/tag/v0.1.0), 4 days ago) - Get the latest version of a repo
