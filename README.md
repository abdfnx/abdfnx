...
- [abdfnx/botway](https://github.com/abdfnx/botway) ([v0.1.1](https://github.com/abdfnx/botway/releases/tag/v0.1.1), today) - 🤖 Generate, build, handle and deploy your own bot with your favorite language, for Discord, or Telegram, or Slack.
- [denoland/deno](https://github.com/denoland/deno) ([v1.23.0](https://github.com/denoland/deno/releases/tag/v1.23.0), today) - A modern runtime for JavaScript and TypeScript.
