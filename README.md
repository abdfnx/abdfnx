...
- [secman-archive/sm-win](https://github.com/secman-archive/sm-win) - sub-app of secman for windows. (1 day ago)
...
- [scmn-dev/secman](https://github.com/scmn-dev/secman) ([v6.0.61](https://github.com/scmn-dev/secman/releases/tag/v6.0.61), 1 day ago) - 🔒 The password manager of your dreams.
- [scmn-dev/docker](https://github.com/scmn-dev/docker) ([v0.3.0](https://github.com/scmn-dev/docker/releases/tag/v0.3.0), 5 days ago) - 🐳 official docker image for secman.
...
- [rename `IS_FROM_SCRIPT` env variable to `SM_PROVIDOR`](https://github.com/scmn-dev/cli.secman.dev/pull/12) on [scmn-dev/cli.secman.dev](https://github.com/scmn-dev/cli.secman.dev) (2 days ago)
- [Zyedidia master](https://github.com/zyedidia/micro/pull/2267) on [zyedidia/micro](https://github.com/zyedidia/micro) (4 days ago)
- [README: add MacPorts install info (#2265)](https://github.com/scmn-dev/win-editor/pull/1) on [scmn-dev/win-editor](https://github.com/scmn-dev/win-editor) (4 days ago)
