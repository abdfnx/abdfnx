...
- [scmn-dev/desktop](https://github.com/scmn-dev/desktop) ([v1.1.1](https://github.com/scmn-dev/desktop/releases/tag/v1.1.1), today) - 🖥️ Secman Desktop is the desktop client for secman. powered by @scmn-dev.
