...
- [secman-archive/desktop](https://github.com/secman-archive/desktop) - Moved to https://github.com/scmn-dev/secman/tree/main/desktop (1 day ago)
- [scmn-dev/scoop](https://github.com/scmn-dev/scoop) - 📥 scoop packaging for secman. (6 days ago)
...
- [denoland/deno](https://github.com/denoland/deno) ([v1.20.3](https://github.com/denoland/deno/releases/tag/v1.20.3), 5 days ago) - A modern runtime for JavaScript and TypeScript.
- [scmn-dev/secman](https://github.com/scmn-dev/secman) ([v6.2.2](https://github.com/scmn-dev/secman/releases/tag/v6.2.2), 6 days ago) - 👊 Human-friendly and amazing secrets manager.
