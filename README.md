...
- [scmn-dev/secman](https://github.com/scmn-dev/secman) ([v6.2.2](https://github.com/scmn-dev/secman/releases/tag/v6.2.2), today) - 👊 Human-friendly and amazing TUI secrets manager.
- [denoland/deno](https://github.com/denoland/deno) ([v1.20.2](https://github.com/denoland/deno/releases/tag/v1.20.2), today) - A modern runtime for JavaScript and TypeScript.
